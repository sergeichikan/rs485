...
//func send(mb modbus.Client, request *modbus.ProtocolDataUnit) (response *modbus.ProtocolDataUnit, err error) {
...
//func ReadInputRegisters(address, quantity uint16) (results []byte, err error) {
...
func main() {
	...
	//data, err = ReadInputRegisters(64, 1)
	//if err != nil {
	//	panic(err)
	//}
	//log.Println(data)
